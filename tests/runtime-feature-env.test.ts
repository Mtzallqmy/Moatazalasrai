...
const keys = [
  ...
  "CLOUDFLARE_AI_GATEWAY_ENABLED", "CLOUDFLARE_ACCOUNT_ID", "CLOUDFLARE_AI_GATEWAY_ID", "CLOUDFLARE_API_TOKEN", "CLOUDFLARE_AI_GATEWAY_BASE_URL",
] as const;
...
describe("optional production feature configuration", () => {
  ...
  it("accepts complete AI Gateway settings", () => {

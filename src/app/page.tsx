const pillars = [
  ...
  {
    title: "مفاتيح مشفرة",
    desc: "تُحفظ مفاتيح BYOK مشفرة باستخدام AES-256-GCM ولا تصل مطلقًا إلى المتصفح بعد تخزينها.",
  },
  {
    title: "تشغيل قابل للتدقيق",
    desc: "إصدارات للوكلاء، سجل Runs وأحداث واستهلاك Tokens وسجل تدقيق للمؤسسة.",
  },
];

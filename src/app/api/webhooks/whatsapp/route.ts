...
import { runWithSystemDatabaseContext } from "@/lib/security/database-context";
...
async function processAcceptedEvent(eventId: string, message: WhatsAppIncomingMessage) {
  return runWithSystemDatabaseContext("whatsapp-webhook-event", async () => {
    try {
...
export async function POST(request: Request) {
  return runWithSystemDatabaseContext("whatsapp-signed-webhook", async () => {

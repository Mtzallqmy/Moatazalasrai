...
async function processUpdate(input: {
  ...
  return runWithTenantDatabaseContext(input.integration.organizationId, null, async () => {
...
export async function POST(
  ...
  const [integration] = await runWithSystemDatabaseContext("telegram-webhook-integration-lookup", () => db()
    .select()
    .from(integrations)
    .where(and(
  ...
  return runWithTenantDatabaseContext(integration.organizationId, null, async () => {

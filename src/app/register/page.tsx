  ...
  return (
    <main className="app-shell flex min-h-screen items-center justify-center px-4 py-12">
      <section className="glass-panel w-full max-w-lg rounded-3xl p-6 sm:p-8">
        ...
        <div className="mt-8"><AuthForm mode="register" googleEnabled={supabaseAuthConfigured()} turnstileSiteKey={process.env.TURNSTILE_ENABLED === "true" ? process.env.NEXT_PUBLIC_TURNSTILE_SITE_KEY : undefined} /></div>

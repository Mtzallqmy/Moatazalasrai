    ...
    <main className="app-shell">
      <div className="mx-auto max-w-[1500px] px-4 py-6 sm:px-6">
        <header className="glass-panel rounded-3xl p-5 sm:p-7">
          ...
          <p className="eyebrow mt-4">Tenant Diagnostics</p>
          <h1 className="mt-3 text-2xl font-black sm:text-3xl">تشخيص مساحة العمل</h1>
          <p className="mt-2 max-w-4xl text-sm leading-7 text-stone-400">
            فحوص خاصة بالمؤسسة الحالية للخدمات والمزودين والتكاملات والتشغيل، دون منح أي تحكم في البنية العالمية للمنصة.
          </p>
        </header>

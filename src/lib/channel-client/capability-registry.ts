...
export const CHANNEL_CAPABILITY_REGISTRY: readonly ChannelCapability[] = Object.freeze([
  ...
  {
    id: "site_connections.list",
    labelAr: "اتصالات المواقع",
    descriptionAr: "عرض اتصالات المواقع والحسابات الموثقة والوكلاء المرتبطين بها دون كشف بيانات الاعتماد.",
    icon: "🔗",
    ...
    destructive: false,
    adminOnly: false,
    actionId: "cc.connections",
  },
  {
    id: "mcp.list",
    labelAr: "MCP",
    descriptionAr: "عرض خوادم MCP وكتالوج الأدوات والموارد والموجهات الفعلي المسجل للمؤسسة.",
    icon: "🧩",
    requiredPermission: "integrations:read",
    telegramFeatureKey: "telegram.admin_commands",
    whatsappFeatureKey: "whatsapp.admin_commands",

...
The current integration branch already contains `0044_file_intelligence.sql`, so Operational AI Tools follow it as `0045_operational_ai_tools.sql` and `0046_operational_tool_flags.sql`.
